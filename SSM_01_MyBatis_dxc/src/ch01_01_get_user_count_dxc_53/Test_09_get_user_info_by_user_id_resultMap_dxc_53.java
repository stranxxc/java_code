...
public class Test_09_get_user_info_by_user_id_resultMap_dxc_53 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//mapper命名空间+.+sqlID
			int user_id=2;
			User_dxc_53_record user_info = sqlSession.selectOne("ch01_01_get_user_count_dxc_53.User_dxc_53_record_Mapper.getUserInfo_by_user_id_resultMap_test_09_dxc_53");
