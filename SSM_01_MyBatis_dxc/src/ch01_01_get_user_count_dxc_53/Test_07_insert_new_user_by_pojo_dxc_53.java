...
public class Test_07_insert_new_user_by_pojo_dxc_53 {
	...
	public static void main(String[] args) {
		...
		int insert_num=sqlSession.insert("ch01_01_get_user_count_dxc_53.User_dxc_53_record_Mapper.insert_new_user_dxc_53_by_pojo", user_dxc_53_record);
		
		System.out.println("插入记录的条数->dxc->"+insert_num);
